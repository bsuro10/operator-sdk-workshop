...
const hwFinalizer = "finalizer.ran.hw.okto.io"
...
func (r *ReconcileRanHelloWorld) manageDeployment(hw *ranv1alpha1.RanHelloWorld, reqLogger logr.Logger) (*reconcile.Result, error) {
...
func (r *ReconcileRanHelloWorld) manageRoute(hw *ranv1alpha1.RanHelloWorld, reqLogger logr.Logger) (*reconcile.Result, error) {
	//Check if route already exists, if not create a new one
	route := &routev1.Route{}
...
func (r *ReconcileRanHelloWorld) manageService(hw *ranv1alpha1.RanHelloWorld, reqLogger logr.Logger) (*reconcile.Result, error) {
...
func (r *ReconcileRanHelloWorld) manageConfigMap(hw *ranv1alpha1.RanHelloWorld, reqLogger logr.Logger) (*reconcile.Result, error) {
	cm := &corev1.ConfigMap{}
...
func (r *ReconcileRanHelloWorld) routeForWebServer(hw *ranv1alpha1.RanHelloWorld) (*routev1.Route, error) {
	labels := map[string]string{
		"app": hw.Name,
	}
	route := &routev1.Route{
...
func (r *ReconcileRanHelloWorld) configMapForWebServer(hw *ranv1alpha1.RanHelloWorld) (*corev1.ConfigMap, error) {
	labels := map[string]string{
		"app": hw.Name,
	}
	cm := &corev1.ConfigMap{
...
func (r *ReconcileRanHelloWorld) syncConfigMapForWebServer(hw *ranv1alpha1.RanHelloWorld, cm *corev1.ConfigMap) (syncRequired bool, err error) {
...
func (r *ReconcileRanHelloWorld) finalizeHw(hw *ranv1alpha1.RanHelloWorld, reqLogger logr.Logger, ) error {
	...
	channelID, timestamp, err := api.PostMessage("GTMMBFW87", slack.MsgOptionAttachments(attachment))
	if err != nil {
...
func (r *ReconcileRanHelloWorld) addFinalizer(hw *ranv1alpha1.RanHelloWorld, reqLogger logr.Logger) error {
